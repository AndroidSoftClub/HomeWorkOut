...
public class RecyclerViewAdapter_3 extends RecyclerView.Adapter<RecyclerViewAdapter_3.VH> {
    private Activity context;
    private List<Blog> blogArrayList = new ArrayList<>();

    public RecyclerViewAdapter_3(Activity context, List<Blog> blogArrayList) {
    ...
    public class VH extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            if (position == 6 || position == 12 || position == 18 || position == 24)
                openRestTimeActivityFromRV(position,context,blogArrayList,RESTDAY_CODE_3);
            else
                openDayInnerActivityFromRV(position,context,blogArrayList,INTENT_CODE_3);
        }
    }
